...
Five prompts that cover the full Cerebro lifecycle: migrate your existing AI memories, bring over your existing second brain, discover personalized use cases, build the daily capture habit, and run a weekly review.
...
| 3 | [Cerebro Spark](03-cerebro-spark.md) | When you need capture ideas for your specific workflow | No |
...
1. **Start with Memory Migration** — run it in Claude or ChatGPT (whichever has the most memory about you) with your Cerebro MCP connected. This frontloads your cerebro with context every AI can access.
...
4. **Keep the Capture Templates** handy for your first week. They optimize metadata extraction so your cerebro tags and retrieves accurately. Also covers task completion (`done:`), reopen (`reopen:`), and reminder commands (include a date/time to auto-create calendar events).
...
These prompts reference the MCP tools exposed by the Cerebro Azure Function:
...
- `cerebro_stats` — overview stats (used by prompt 5)
