...
> These are not prompts to paste into AI. These are templates for what you type into your Teams capture channel (using the `brain` keyword trigger) or say directly to any MCP-connected AI using "save this" or "remember this."
...
brain completed: the dashboard redesign spec
brain finished: setting up Power Automate digest flows
```
...
```
brain I finally finished the vnet troubleshooting docs
```
...
**Example:**
```
brain reopen: vnet troubleshooting documentation
brain undo: the dashboard redesign
```
